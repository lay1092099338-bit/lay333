...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange }) => {
  const navItems = [
    ...
    { id: 'cam-site', label: 'Live Site', icon: 'fa-video', extra: 'plus' },
    { id: 'vibemate', label: 'VibeMate', icon: 'fa-heart', badge: 'New' },
    { id: 'studios', label: 'Studio Management', icon: 'fa-people-group' },
    { id: 'event-plaza', label: 'Event Plaza', icon: 'fa-bullhorn', highlight: true },
    { id: 'chatbox', label: 'Chat Box', icon: 'fa-comments' },
    { id: 'app-gallery', label: 'App Gallery', icon: 'fa-table-cells' },
    { id: 'visuals', label: 'Visual Effects', icon: 'fa-wand-magic-sparkles', hasChevron: true },
    { id: 'insights', label: 'Data Insights', icon: 'fa-chart-line', hasChevron: true },
  ];
