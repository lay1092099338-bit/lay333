      ...
      <div className="relative bg-white w-full max-w-3xl rounded-[32px] shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        <div className="p-10 border-b relative">
          ...
          <div className="flex items-center space-x-4 mb-2">
            ...
            <h3 className="text-3xl font-black text-gray-800">Campaign Guide</h3>
          </div>
          <p className="text-gray-400">Learn how to maximize your earnings and influence through events.</p>
        </div>
