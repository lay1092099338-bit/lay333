        ...
        <div className="p-10 border-b border-white/5 relative bg-gradient-to-r from-gray-900 to-indigo-950 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex items-center space-x-4 mb-4 md:mb-0">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-1">Test new features, collect points, and win exclusive platform benefits.</p>
            </div>
          </div>

          {/* Testing Points Balance (The new entry point for TP) */}
          <div className="bg-white/5 border border-white/10 px-6 py-4 rounded-2xl flex items-center space-x-4 shadow-inner group transition-all hover:bg-white/10">
             <div className="text-right">
                <p className="text-[10px] text-gray-400 uppercase font-black tracking-widest opacity-60">Testing Balance</p>
                <p className="text-2xl font-black text-indigo-400 leading-tight">
                  {MOCK_USER_STATS.testingPoints.toLocaleString()} 
                  <span className="text-xs font-bold uppercase opacity-60 ml-1.5">TP</span>
                </p>
             </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0 md:space-x-10">
               <div className="flex-1">
                 ...
                 <p className="text-gray-400 leading-relaxed text-sm">
                   Testing Points (TP) are special rewards for active testers. <span className="text-white font-bold">Test, collect points, and win!</span> Earn <b>100 - 1,000 TP</b> by providing valid bugs, experience suggestions, or discovering security flaws. TP can be redeemed for exclusive Pioneer Badges and platform priority access.
                 </p>
               </div>
               <div className="grid grid-cols-2 gap-4 shrink-0">
                  <div className="bg-gray-800 p-4 rounded-2xl text-center min-w-[140px] border border-white/5">
