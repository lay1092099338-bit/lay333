...
const EventPlaza: React.FC = () => {
  ...
  const filteredEvents = MOCK_EVENTS.filter(e => {
    ...
    if (filter === 'Ongoing') return e.status === EventStatus.ONGOING;
    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-12">
      ...
      <div className="relative h-48 rounded-[32px] overflow-hidden tech-gradient shadow-xl flex items-center px-12 transition-all duration-500 hover:shadow-2xl">
        ...
        <div className="relative z-10 text-white max-w-xl">
          <h1 className="text-4xl font-black mb-2 tracking-tight">Event Plaza <span className="text-xl font-normal opacity-80 ml-2 italic">Official Incentive Program</span></h1>
          <p className="text-lg opacity-90 mb-6">Join platform events to boost traffic and earnings. Earn exclusive Lovense Cash rewards.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="relative z-10 h-full flex flex-col">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-2">
                ...
                <p className="text-gray-800 font-black uppercase tracking-wider text-xs">Event Stats</p>
              </div>
              <button 
            ...
            <div className="flex-1 space-y-4">
              <div className="flex justify-between items-end">
                <div>
                  ...
                  <p className="text-3xl font-black text-gray-900">{MOCK_USER_STATS.totalEvents}<span className="text-xs font-normal ml-1">Events</span></p>
                </div>
                <div className="text-right">
                  <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest">Beat</p>
              ...
              <div className="grid grid-cols-2 gap-2 pt-2 border-t border-gray-50">
                <div className="bg-gray-50 p-2 rounded-xl">
                  <p className="text-[9px] text-gray-400 font-black uppercase mb-0.5">Total Viewers</p>
        ...
        <div className="md:col-span-1 bg-white p-6 rounded-[24px] shadow-sm border border-gray-100 flex flex-col justify-between group cursor-pointer hover:border-pink-200 transition-colors"
          ...
          <div className="flex justify-between items-start">
            <div>
              <p className="text-gray-500 text-[10px] font-black uppercase tracking-widest mb-1">LOVENSE CASH (1:1 USD)</p>
              <div className="flex items-center space-x-2">
        ...
        <div className="md:col-span-2 bg-white p-6 rounded-[24px] shadow-sm border border-gray-100 overflow-hidden relative">
          <div className="absolute top-4 right-4 text-[10px] font-black text-gray-300 uppercase tracking-widest">Earnings Insights</div>
          <h3 className="text-lg font-black text-gray-800 mb-4 flex items-center">
             ...
             Avg Earnings Comparison <span className="text-xs font-normal text-gray-400 ml-2">(Tokens)</span>
          </h3>
          <ComparisonChart />
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between border-b border-gray-200 pb-4">
          <div className="flex items-center space-x-8">
             <h2 className="text-2xl font-black text-gray-800">Explore Hot Events</h2>
          ...
          <div className="hidden sm:flex items-center space-x-2 bg-white px-4 py-2 rounded-xl border text-xs">
            <span className="text-gray-400 font-bold uppercase">Sort:</span>
            <button className="text-gray-800 font-black flex items-center">
              Newly Published <i className="fa-solid fa-chevron-down ml-2 text-[10px]"></i>
            </button>
          </div>
        </div>
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
          <div className="mb-8 md:mb-0 max-w-2xl">
             <div className="flex items-center space-x-3 mb-4">
                <span className="bg-pink-500 text-[10px] font-black px-3 py-1 rounded-lg uppercase tracking-widest">Early Adopter Beta</span>
                <h3 className="text-3xl font-black">Testing Center</h3>
             </div>
             <p className="text-gray-400 text-lg leading-relaxed">Limited to studios and core partners. Experience new interactive modules early, help us optimize, and earn exclusive "Testing Points" rewards.</p>
          </div>
          <button 
          ...
          >
            ...
            <span className="uppercase tracking-widest">Enter Testing Center ({grayTestEvents.length})</span>
          </button>
        </div>
      </div>
