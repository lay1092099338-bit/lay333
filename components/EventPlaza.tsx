      ...
      <div className="bg-gray-900 rounded-[40px] p-12 text-white relative overflow-hidden group">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
          <div className="mb-8 md:mb-0 max-w-2xl">
             ...
             <p className="text-gray-400 text-lg leading-relaxed">Test new features, collect points, and win exclusive platform benefits. Limited to studios and core partners.</p>
          </div>
          <button 
